...
/**
 * \file    test/phpunit/DoliTypologyFunctionalTest.php
...
/**
 * Class DoliTypologyFunctionalTest
 *
 ...
 *
 * @package Testdolitypology
 */
class DoliTypologyFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoliTypology')->click();
		} else {
			// Disable the module
			$this->byHref('modDoliTypology')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/dolitypology/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolitypology/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolitypology/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolitypology/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolitypologywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliTypology_DoliTypologyTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliTypology_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
