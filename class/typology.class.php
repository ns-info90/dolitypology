...
/**
 * \file        class/typology.class.php
 * \ingroup     dolitypology
 * \brief       This file is a CRUD class file for Typology (Create/Read/Update/Delete)
 */
 ...
 * Class for Typology
 */
class Typology extends CommonObject
{
	 ...
	 */
	public $module = 'dolitypology';
	/**
	 * @var string ID to identify managed object.
	 */
	public $element = 'typology';
	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'dolitypology_typology';
	/**
	...
	public $fields=array(
		...
		'label' => array('type'=>'varchar(255)', 'label'=>'Label', 'enabled'=>'1', 'position'=>30, 'notnull'=>1, 'visible'=>1, 'searchall'=>1, 'css'=>'minwidth300', 'cssview'=>'wordbreak', 'help'=>"Help text", 'showoncombobox'=>'2',),
		...
		'status' => array('type'=>'smallint', 'label'=>'Status', 'enabled'=>'1', 'position'=>1000, 'notnull'=>1, 'visible'=>0, 'default'=>1, 'index'=>1, 'arrayofkeyval'=>array('0'=>'Disabled', '1'=>'Enabled',)),
	);
	public $rowid;
	public $label;
	public $element_type;
	...
	public function __construct(DoliDB $db)
	{
		...
		/*if ($user->rights->dolitypology->typology->read) {
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_DISABLED, $notrigger, 'TYPOLOGY_UNVALIDATE');
	}
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$label = img_picto('', $this->picto) . ' <u>' . $langs->trans("Typology") . '</u>';
		...
		$url = dol_buildpath('/dolitypology/typology_card.php', 1) . '?id=' . $this->id;
		...
		if (empty($notooltip)) {
			if (!empty($conf->global->MAIN_OPTIMIZEFORTEXTBROWSER)) {
				$label = $langs->trans("ShowTypology");
		...
		$hookmanager->initHooks(array('typologydao'));
	...
	public function manageExtrafieldsObject($user) {
		if ($this->status==$this::STATUS_ENABLED) {
			...
			if ($createExtra) {
				$result = $extrafields->addExtraField('dolitypo_typo', "Typology", 'chkbxlst', 1, '', $this->element_type, 0, 0, '', array('options' => array($this->table_element . ':label:rowid::(status:=:' . $this::STATUS_ENABLED . ') AND (element_type:=:\'' . $this->element_type . '\')' => null)), 1, '', 1, 0, '', '', 'dolitypology@dolitypology', '$conf->dolitypology->enabled');
				if ($result < 0) {
					return -1;
				}
			}
