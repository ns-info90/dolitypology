...
/**
 *  \file       typology_agenda.php
 *  \ingroup    dolitypology
 *  \brief      Tab of events on Typology
 */
...
$hookmanager->initHooks(array('typologyagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnTypology"), '', '');
