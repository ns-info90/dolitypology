...
/**
 *  \file       typology_note.php
 *  \ingroup    dolitypology
 *  \brief      Tab for notes on Typology
 */
...
$hookmanager->initHooks(array('typologynote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->dolitypology->typology->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('Typology'), $help_url);
