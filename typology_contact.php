...
/**
 *  \file       typology_contact.php
 *  \ingroup    dolitypology
 *  \brief      Tab for contacts linked to Typology
 */
...
$hookmanager->initHooks(array('typologycontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->dolitypology->typology->write;
...
$title = $langs->trans('Typology')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
