...
/**
 *  \file       dolitypology/myobject_contact.php
...
dol_include_once('/dolitypology/class/myobject.class.php');
dol_include_once('/dolitypology/lib/dolitypology_myobject.lib.php');
...
$permission = $user->rights->dolitypology->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/dolitypology/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
